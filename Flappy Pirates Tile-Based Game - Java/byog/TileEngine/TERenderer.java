...
public class TERenderer implements Serializable {
     ...
     */
    public void initialize(int w, int h, int xOff, int yOff, Color c) {
        this.width = w;
        this.height = h;
        this.xOffset = xOff;
        this.yOffset = yOff;
        ...
        StdDraw.clear(c); //new Color(0, 0, 0)
     ...
     * @param h height of the window in tiles.
     */
    public void initialize(int w, int h, Color c) {
        initialize(w, h, 0, 0, c);
    }
