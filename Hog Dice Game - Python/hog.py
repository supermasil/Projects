...
def roll_dice(num_rolls, dice=six_sided):
    ...
    outcome = 0
    counter = 1
    pig_out = 0  # pig_out will be != 0 if it happens
    while counter <= num_rolls:
        ...
        counter += 1
    return outcome if pig_out == 0 else 1
    # END PROBLEM 1
...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    if score0 == 0 or score1 == 0 or score0 == 1 or score1 == 1:
        return False
    else:
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def highest(score0, score1):
        ...
        point = 'point' if difference == 1 else 'points'
        high = previous_high
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while counter <= 10:
        ...
        average = average_dice(counter, dice)
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    return 0 if bacon >= margin else num_rolls
    # END PROBLEM 10
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    result = score + bacon
    #Beneficial swap
    if(result < opponent_score and is_swap(result, opponent_score) and opponent_score - result >= margin):
        return 0
    else:
        return 0 if bacon >= margin else num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    """Enfore the swap_strategy with num_rolls derived from max_scoring_num_rolls

    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    #def tryout(dice = six_sided):
    num_rolls = swap_strategy(score, opponent_score, 7, 4)
    if num_rolls == 0: #Min num_rolls to win, no need to test > 100
        return 0
    else: #Any other num_rolls > 0
        if roll_dice(num_rolls) < 100:
            return num_rolls
        else: #roll_dice > 100
            counter = num_rolls - 1 #Already tested counter = num_rolls in else
            final_num_rolls = num_rolls
            while counter > 0:
                if roll_dice(counter) > 100: #Any small num_rolls that still gives > 100
                    final_num_rolls = counter
                counter -= 1
